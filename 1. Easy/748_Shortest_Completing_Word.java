...
class Solution {
    public String shortestCompletingWord(String licensePlate, String[] words) {
        ArrayList<String> list = new ArrayList<>(); //Declaring ArrayList to store the strings satisfying the question's conditions
        ...
        return ele; //return the string of smallest length
